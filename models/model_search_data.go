...
// checks if the SearchData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchData{}
...
func (o SearchData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["results"] = o.Results
	return toSerialize, nil
}

func (o *SearchData) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchData := _SearchData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchData)

	if err != nil {
		return err
	}

	*o = SearchData(varSearchData)
