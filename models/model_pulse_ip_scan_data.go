...
// checks if the PulseIpScanData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PulseIpScanData{}

// PulseIpScanData struct for PulseIpScanData
type PulseIpScanData struct {
...
type _PulseIpScanData PulseIpScanData

// NewPulseIpScanData instantiates a new PulseIpScanData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPulseIpScanData(crawlsnapHashId string, searchType string) *PulseIpScanData {
	this := PulseIpScanData{}
	this.CrawlsnapHashId = crawlsnapHashId
	this.SearchType = searchType
	return &this
}

// NewPulseIpScanDataWithDefaults instantiates a new PulseIpScanData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPulseIpScanDataWithDefaults() *PulseIpScanData {
	this := PulseIpScanData{}
	return &this
}

// GetCrawlsnapHashId returns the CrawlsnapHashId field value
func (o *PulseIpScanData) GetCrawlsnapHashId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *PulseIpScanData) GetCrawlsnapHashIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PulseIpScanData) SetCrawlsnapHashId(v string) {
	o.CrawlsnapHashId = v
}

// GetSearchType returns the SearchType field value
func (o *PulseIpScanData) GetSearchType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PulseIpScanData) GetSearchTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PulseIpScanData) SetSearchType(v string) {
	o.SearchType = v
}

// GetPulseDetail returns the PulseDetail field value if set, zero value otherwise.
func (o *PulseIpScanData) GetPulseDetail() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *PulseIpScanData) GetPulseDetailOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.PulseDetail) {
...
func (o *PulseIpScanData) HasPulseDetail() bool {
	if o != nil && !IsNil(o.PulseDetail) {
		return true
	}
...
func (o *PulseIpScanData) SetPulseDetail(v map[string]interface{}) {
	o.PulseDetail = v
}

// GetMalware returns the Malware field value if set, zero value otherwise.
func (o *PulseIpScanData) GetMalware() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *PulseIpScanData) GetMalwareOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.Malware) {
		return nil, false
	}
...
func (o *PulseIpScanData) HasMalware() bool {
	if o != nil && !IsNil(o.Malware) {
		return true
	}
...
func (o *PulseIpScanData) SetMalware(v []map[string]interface{}) {
	o.Malware = v
}

// GetPassiveDns returns the PassiveDns field value if set, zero value otherwise.
func (o *PulseIpScanData) GetPassiveDns() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *PulseIpScanData) GetPassiveDnsOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.PassiveDns) {
		return nil, false
	}
...
func (o *PulseIpScanData) HasPassiveDns() bool {
	if o != nil && !IsNil(o.PassiveDns) {
		return true
	}
...
func (o *PulseIpScanData) SetPassiveDns(v []map[string]interface{}) {
	o.PassiveDns = v
}

func (o PulseIpScanData) MarshalJSON() ([]byte, error) {
...
func (o PulseIpScanData) ToMap() (map[string]interface{}, error) {
...
func (o *PulseIpScanData) UnmarshalJSON(data []byte) (err error) {
	...
	varPulseIpScanData := _PulseIpScanData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPulseIpScanData)

	if err != nil {
		return err
	}

	*o = PulseIpScanData(varPulseIpScanData)

	return err
}

type NullablePulseIpScanData struct {
	value *PulseIpScanData
	isSet bool
}

func (v NullablePulseIpScanData) Get() *PulseIpScanData {
	return v.value
}

func (v *NullablePulseIpScanData) Set(val *PulseIpScanData) {
	v.value = val
	v.isSet = true
}

func (v NullablePulseIpScanData) IsSet() bool {
	return v.isSet
}

func (v *NullablePulseIpScanData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePulseIpScanData(val *PulseIpScanData) *NullablePulseIpScanData {
	return &NullablePulseIpScanData{value: val, isSet: true}
}

func (v NullablePulseIpScanData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePulseIpScanData) UnmarshalJSON(src []byte) error {
	v.isSet = true
