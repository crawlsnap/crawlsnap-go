...
// checks if the Coach type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Coach{}

// Coach struct for Coach
type Coach struct {
	Id   NullableInt64  `json:"id,omitempty"`
	Name NullableString `json:"name,omitempty"`
}

// NewCoach instantiates a new Coach object
...
// NewCoachWithDefaults instantiates a new Coach object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCoachWithDefaults() *Coach {
	this := Coach{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Coach) GetId() int64 {
...
func (o *Coach) GetIdOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Coach) SetId(v int64) {
	o.Id.Set(&v)
}

// SetIdNil sets the value for Id to be an explicit nil
func (o *Coach) SetIdNil() {
	o.Id.Set(nil)
}

// UnsetId ensures that no value is present for Id, not even an explicit nil
func (o *Coach) UnsetId() {
	o.Id.Unset()
}

// GetName returns the Name field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Coach) GetName() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Coach) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Coach) SetName(v string) {
	o.Name.Set(&v)
}

// SetNameNil sets the value for Name to be an explicit nil
func (o *Coach) SetNameNil() {
	o.Name.Set(nil)
}

// UnsetName ensures that no value is present for Name, not even an explicit nil
func (o *Coach) UnsetName() {
	o.Name.Unset()
}

func (o Coach) MarshalJSON() ([]byte, error) {
...
func (o Coach) ToMap() (map[string]interface{}, error) {
...
type NullableCoach struct {
	value *Coach
	isSet bool
}

func (v NullableCoach) Get() *Coach {
	return v.value
}

func (v *NullableCoach) Set(val *Coach) {
	v.value = val
	v.isSet = true
}

func (v NullableCoach) IsSet() bool {
	return v.isSet
}

func (v *NullableCoach) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoach(val *Coach) *NullableCoach {
	return &NullableCoach{value: val, isSet: true}
}

func (v NullableCoach) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoach) UnmarshalJSON(src []byte) error {
	v.isSet = true
