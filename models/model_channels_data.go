...
// checks if the ChannelsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChannelsData{}

// ChannelsData struct for ChannelsData
type ChannelsData struct {
	Country  *ChannelsDataCountry `json:"country,omitempty"`
	Channels []ChannelListing     `json:"channels"`
}

type _ChannelsData ChannelsData

// NewChannelsData instantiates a new ChannelsData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewChannelsData(channels []ChannelListing) *ChannelsData {
	this := ChannelsData{}
	this.Channels = channels
	return &this
}

// NewChannelsDataWithDefaults instantiates a new ChannelsData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewChannelsDataWithDefaults() *ChannelsData {
	this := ChannelsData{}
	return &this
}

// GetCountry returns the Country field value if set, zero value otherwise.
func (o *ChannelsData) GetCountry() ChannelsDataCountry {
	if o == nil || IsNil(o.Country) {
		var ret ChannelsDataCountry
		return ret
	}
	return *o.Country
}
...
func (o *ChannelsData) GetCountryOk() (*ChannelsDataCountry, bool) {
	if o == nil || IsNil(o.Country) {
		return nil, false
	}
...
func (o *ChannelsData) HasCountry() bool {
	if o != nil && !IsNil(o.Country) {
		return true
	}
...
// SetCountry gets a reference to the given ChannelsDataCountry and assigns it to the Country field.
func (o *ChannelsData) SetCountry(v ChannelsDataCountry) {
	o.Country = &v
}

// GetChannels returns the Channels field value
func (o *ChannelsData) GetChannels() []ChannelListing {
	if o == nil {
		var ret []ChannelListing
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ChannelsData) GetChannelsOk() ([]ChannelListing, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ChannelsData) SetChannels(v []ChannelListing) {
	o.Channels = v
}

func (o ChannelsData) MarshalJSON() ([]byte, error) {
...
func (o ChannelsData) ToMap() (map[string]interface{}, error) {
...
func (o *ChannelsData) UnmarshalJSON(data []byte) (err error) {
	...
	varChannelsData := _ChannelsData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChannelsData)

	if err != nil {
		return err
	}

	*o = ChannelsData(varChannelsData)

	return err
}

type NullableChannelsData struct {
	value *ChannelsData
	isSet bool
}

func (v NullableChannelsData) Get() *ChannelsData {
	return v.value
}

func (v *NullableChannelsData) Set(val *ChannelsData) {
	v.value = val
	v.isSet = true
}

func (v NullableChannelsData) IsSet() bool {
	return v.isSet
}

func (v *NullableChannelsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChannelsData(val *ChannelsData) *NullableChannelsData {
	return &NullableChannelsData{value: val, isSet: true}
}

func (v NullableChannelsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChannelsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
